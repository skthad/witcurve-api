...
public class AwsConfiguration {
    ...
    public AmazonSNS amazonSNSClient() {
        AWSCredentials awsCredentials = new BasicAWSCredentials(applicationProperties.getAws().getAccesskey(), applicationProperties.getAws().getSecretKey());
        return AmazonSNSClientBuilder.standard()
            .withRegion(Regions.fromName(applicationProperties.getAws().getSnsRegion()))
